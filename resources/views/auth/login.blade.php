...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-6">
            <a href="{{ url('login/google')}}" class="btn btn-success"><i class="fa fa-google"> Google</i></a>
            <a href="{{ url('login/twitter')}}" class="btn btn-info"><i class="fa fa-twitter"> Twitter</i></a>
